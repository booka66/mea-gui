...
async def main(tag=None, no_package=False):
    ...
    if sys.platform == "darwin":
        ...
        pyinstaller_command = """pyinstaller --collect-submodules --noconfirm --onedir --windowed main.py --icon=icon.ico --add-data "sz_se_detect.cp311-win_amd64.pyd:." --add-data "hdf5.dll:." --add-data "hdf5_cpp.dll:." --add-data "SzDetectCat.m:." --add-data "save_channel_to_mat.m:." --add-data "getChs.m:." --add-data "get_cat_envelop.m:." --additional-hooks-dir "hooks" --add-data "*.m:."
            """
        package_commands = [
